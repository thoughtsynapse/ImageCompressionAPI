...
:wrench: Image Compressor API compresses JPG, PNG, GIF & SVG images, the compression type is lossy.   
:wrench: You can choose the quality of compression you would like.   
:wrench: The API returns the URL of orignal and compressed image in a JSON object along with orignal and compressed image size in KB.   
:wrench: Documentation for installing Compressor API on DigitalOcean Ubuntu 20.04 Droplet is explained below.   
:wrench: Before proceeding to that, please create a DigitalOcean Ubuntu 20.04 Droplet and point your domain's A Reocrd to the Droplet's IP.   
